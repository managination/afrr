      ...
      <InfoIcon
        tooltip={
          <Card variant="tooltip" sx={{ width: ["220px", "518px"] }}>
            <Paragraph>
              An <Text sx={{ fontWeight: "bold" }}>estimate</Text> of the AFRR return on the EEUR
              deposited to the Stability Pool over the next year, not including your EWT gains from
              liquidations.
            </Paragraph>
