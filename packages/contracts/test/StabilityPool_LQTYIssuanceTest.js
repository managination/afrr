...
contract('StabilityPool - LQTY Rewards', async accounts => {
    ...
    describe("LQTY Rewards", async() => {
        ...
        beforeEach(async() => {
            ...
            // Check community issuance starts with 100 million LQTY
            communityLQTYSupply = toBN(await lqtyToken.balanceOf(communityIssuanceTester.address))
            assert.isAtMost(getDifference(communityLQTYSupply, '100000000000000000000000000'), 1000)
      ...
      */
        ...
        it("withdrawFromSP(): Depositors with equal initial deposit withdraw correct LQTY gain. No liquidations. No front end.", async() => {
            ...
            const expectedLQTYGain_2yr = expectedLQTYGain_1yr.mul(toBN('2')) // communityLQTYSupply.mul(toBN('3')).div(toBN('4')).div(toBN('3'))
        ...
        it("withdrawFromSP(): Depositors with varying initial deposit withdraw correct LQTY gain. No liquidations. No front end.", async() => {
            ...
            const A_expectedLQTYGain_1yr = communityLQTYSupply.mul(toBN('525600')).div(toBN('100000000')).div(toBN('6'))

            // const B_expectedLQTYGain_1yr = communityLQTYSupply
            //    .div(toBN('2')) // 50% of total issued after 1 year
            //    .div(toBN('3')) // B gets 2/6 = 1/3 of the issuance
            const B_expectedLQTYGain_1yr = communityLQTYSupply.mul(toBN('525600')).div(toBN('100000000')).div(toBN('3'))

            // const C_expectedLQTYGain_1yr = communityLQTYSupply
            //    .div(toBN('2')) // 50% of total issued after 1 year
            //    .div(toBN('2')) // C gets 3/6 = 1/2 of the issuance
            const C_expectedLQTYGain_1yr = communityLQTYSupply.mul(toBN('525600')).div(toBN('100000000')).div(toBN('2'))
            ...
            //    .div(toBN('6')) // A gets 1/6 of the issuance
            const A_expectedLQTYGain_2yr = communityLQTYSupply.mul(toBN('525600')).div(toBN('100000000')).mul(toBN('2')).div(toBN('6'))

            // const B_expectedLQTYGain_2yr = communityLQTYSupply
            //    .mul(toBN('3')).div(toBN('4')) // 75% of total issued after 1 year
            //    .div(toBN('3')) // B gets 2/6 = 1/3 of the issuance
            const B_expectedLQTYGain_2yr = communityLQTYSupply.mul(toBN('525600')).div(toBN('100000000')).mul(toBN('2')).div(toBN('3'))

            // const C_expectedLQTYGain_2yr = communityLQTYSupply
            //    .mul(toBN('3')).div(toBN('4')) // 75% of total issued after 1 year
            //    .div(toBN('2')) // C gets 3/6 = 1/2 of the issuance
            const C_expectedLQTYGain_2yr = communityLQTYSupply.mul(toBN('525600')).div(toBN('100000000')).mul(toBN('2')).div(toBN('2'))
        ...
        it("withdrawFromSP(): Depositors with varying initial deposit withdraw correct LQTY gain. No liquidations. No front end.", async() => {
            ...
            const A_expectedLQTYGain_Y1 = communityLQTYSupply.mul(toBN('525600')).div(toBN('100000000')).div(toBN('6'))

            // const B_expectedLQTYGain_Y1 = communityLQTYSupply
            //    .div(toBN('2')) // 50% of total issued in Y1
            //    .div(toBN('3')) // B gets 2/6 = 1/3 of the issuance
            const B_expectedLQTYGain_Y1 = communityLQTYSupply.mul(toBN('525600')).div(toBN('100000000')).div(toBN('3'))

            // const C_expectedLQTYGain_Y1 = communityLQTYSupply
            //    .div(toBN('2')) // 50% of total issued in Y1
            //    .div(toBN('2')) // C gets 3/6 = 1/2 of the issuance
            const C_expectedLQTYGain_Y1 = communityLQTYSupply.mul(toBN('525600')).div(toBN('100000000')).div(toBN('2'))
            ...
            const A_expectedLQTYGain_Y2 = communityLQTYSupply.mul(toBN('525600')).div(toBN('100000000')).div(toBN('14'))

            // const B_expectedLQTYGain_Y2 = communityLQTYSupply
            //    .div(toBN('4')) // 25% of total issued in Y2
            //    .div(toBN('7')) // B got 100/700 = 1/7 of the issuance
            const B_expectedLQTYGain_Y2 = communityLQTYSupply.mul(toBN('525600')).div(toBN('100000000')).div(toBN('7'))

            // const C_expectedLQTYGain_Y2 = communityLQTYSupply
            //    .div(toBN('4')) // 25% of total issued in Y2
            //    .mul(toBN('3')).div(toBN('14')) // C gets 150/700 = 3/14 of the issuance
            const C_expectedLQTYGain_Y2 = communityLQTYSupply.mul(toBN('525600')).div(toBN('100000000')).mul(toBN('3')).div(toBN('14'))

            // const D_expectedLQTYGain_Y2 = communityLQTYSupply
            //    .div(toBN('4')) // 25% of total issued in Y2
            //    .mul(toBN('4')).div(toBN('7')) // D gets 400/700 = 4/7 of the issuance
            const D_expectedLQTYGain_Y2 = communityLQTYSupply.mul(toBN('525600')).div(toBN('100000000')).mul(toBN('4')).div(toBN('7'))
